...
const UpdateJob = () => {
    ...
    const onSubmit = (data) => {
        ...
        fetch(`https://job-portal-u10r.onrender.com/update-job/${id}`, {
            method: 'PATCH',
            headers: {
            ...
            res.acknowledged ? alert('Job Update Successfully!!') : res.message ? alert(res.message) : alert('Please try again later.')
            reset()
            setTimeout(() => navigate('/my-job'), 1000)
        })
    }
    const options = [
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="create-job-flex">
                        <div className="lg:w-1/2 w-full">
                            ...
                            <input type="date" defaultValue={postingDate} placeholder="Ex: 2023-11-28" {...register('postingDate')} className="create-job-input" />
                        </div>
                        <div className="lg:w-1/2 w-full">
                    ...
                    <div className="create-job-flex">
                        <div className="lg:w-1/2 w-full">
                            ...
                            <input type="url" defaultValue={companyLogo} placeholder="Paste your image url" {...register('companyLogo')} className="create-job-input" />
                        </div>
                        <div className="lg:w-1/2 w-full">
